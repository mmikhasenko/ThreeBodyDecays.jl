...
DocMeta.setdocmeta!(ThreeBodyDecays, :DocTestSetup, :(using ThreeBodyDecays); recursive = true)
...
makedocs(;
  ...
  format = Documenter.HTML(; canonical = "https://mmikhasenko.github.io/ThreeBodyDecays.jl"),
  pages = [
    "index.md"
    [
      file for
