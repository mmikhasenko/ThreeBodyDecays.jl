...
3. Add this repo as a remote:
   ...
   ```bash
   git remote add upstream https://github.com/mmikhasenko/ThreeBodyDecays.jl
   ```
...
- After that runs, the [stable docs](https://mmikhasenko.github.io/ThreeBodyDecays.jl/stable) should be updated. Check them and look for the version number.
