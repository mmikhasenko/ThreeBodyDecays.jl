...
(bw::BlattWeisskopf{L})(p::Number) where {L} = error("BlattWeisskopf{L} is not defined for L>7")
...
sqrt(z² / chi_poly3(z²)))
(bw::BlattWeisskopf{4})(p::Number) = (z² = (bw.d * p)^2;
sqrt(z² / chi_poly4(z²)))
(bw::BlattWeisskopf{5})(p::Number) = (z² = (bw.d * p)^2;
sqrt(z² / chi_poly5(z²)))
(bw::BlattWeisskopf{6})(p::Number) = (z² = (bw.d * p)^2;
sqrt(z² / chi_poly6(z²)))
(bw::BlattWeisskopf{7})(p::Number) = (z² = (bw.d * p)^2;
sqrt(z² / chi_poly7(z²)))
# 
chi_poly0(z²) = one(z²)
chi_poly1(z²) = 1 + z²
